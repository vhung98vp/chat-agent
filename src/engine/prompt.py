...
- If has relation_type but doesn't have info of target entity, prioritize single entity with relation_type, src_name (not return name) other info as info fields
